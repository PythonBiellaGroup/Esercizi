...
class Bird(Pet):
    ...
    def __init__(self, name="Kitty", chirp_number=2):
        ...
        # basically, call the SUPER -- the parent version -- of the
        # constructor, with all the parameters that it needs.
        # now, also assign the new instance variable
...
class Tiger(Cat):
    def __init__(self, name="Fluffy", meow_number=5):
        super().__init__(name, meow_number)
...
pet_types = {'dog': Dog, 'lab': Lab, 'poodle': Poodle, 'cat': Cat, 'bird': Bird,
             'tiger': Tiger, 'retriever': Retriever}
