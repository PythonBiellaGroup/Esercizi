...
class Retriever(Lab):
     def fetch(self):
         ...
         return Lab.fetch(self) + "I can fetch anything!"
     def hi(self):
         Lab.hi(self)

class Tiger(Cat):
   
    def __init__(self, name="MyTiger", meow_count=5):
...
def play():
    ...
    base_prompt = """
        Quit
        Adopt <petname_with_no_spaces> <adopt_type - choose dog, cat, lab, poodle, tiger, retriever or another unknown pet type>
        Greet <petname>
        Teach <petname> <word>
        Feed <petname>
